...
update visita_concordancia 
set latitud_visita = substring(latitud_visita,1,9)
go

update visita_concordancia 
set latitud_IPRESS = substring(latitud_IPRESS,1,9)
go
...
update visita_concordancia 
set longitud_visita = replace(longitud_visita,',','')
go

update visita_concordancia 
set latitud_visita = replace(latitud_visita,',','')
go
*/
...
/*
update visita_concordancia
set		distancia = 1000*6371.01*ACOS(
